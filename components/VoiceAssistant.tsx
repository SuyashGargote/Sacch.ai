...
import { Mic, MicOff, Activity, Power, Info, Volume2, Radio, User, Cpu, Pause, Play } from 'lucide-react';
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 z-10 w-full">
              {!isActive ? (
                 ...
                 <>
                    ...
                    <button
                      onClick={stopSession}
                      className="px-6 py-3 md:px-8 md:py-4 bg-white dark:bg-slate-800 hover:bg-red-50 dark:hover:bg-red-500/20 hover:border-red-500 border border-slate-200 dark:border-slate-700 rounded-full text-slate-700 dark:text-white font-bold transition-colors"
                    >
